            ...
            <div className={`flex flex-col gap-6 items-center h-full w-full`}>
                ...
                <div className={`flex flex-row gap-8 items-center mt-8`}>
                    <Button variant="default" className="bg-neutral-50 text-neutral-800 hover:bg-neutral-200">
                        <a href="mailto:s44thomp@gmail.com">Contact Me</a> 
                    </Button>
                    <a href="https://www.linkedin.com/in/sara-thompson-s44/" className="group inline-flex items-center text-neutral-50 font-light" target="_blank" rel="noopener noreferrer"  >
